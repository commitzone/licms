				...
				<div class="col-lg-6">
					<form class="form-horizontal" id="singcms-form">
						<div class="form-group">
							<label for="inputname" class="col-sm-2 control-label">推荐位id:</label>
							<div class="col-sm-5">
								<input type="text" name="position_id" class="form-control" id="inputname" placeholder="可不填" value="<?php echo ($position["id"]); ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="inputname" class="col-sm-2 control-label">推荐位名称:</label>
							<div class="col-sm-5">
								<input type="text" name="title" class="form-control" id="inputname" placeholder="请填写标题" value="<?php echo ($position["name"]); ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" name="url" id="inputPassword3" placeholder="可不填" value="<?php echo ($position["description"]); ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								...
								<input type="radio" name="status" id="optionsRadiosInline2" value="-1" <?php if($position["status"] == -1): ?>checked<?php endif; ?>> 删除
							</div>
...
<script>
	var SCOPE = {
		...
		'jump_url' : '/admin.php?c=position', //添加功能中给予ajax的url
