<?php if (!defined('THINK_PATH')) exit();?><!--网站头部导航信息-->
<?php
    ...
    <div class="navbar-inverse">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-left">
                <li><a href="/" <?php if($reslut['catid'] == 0): ?>class="curr"<?php endif; ?>>首页</a></li>
      ...
      <div class="col-sm-9 col-md-9">
        <div class="banner">
          <div class="banner-left">
            ...
            <a target="_blank" href="/index.php?c=detail&id=<?php echo ($result['topPicNews'][0]['news_id']); ?>"><img  width="670" height="360" src="<?php echo ($result['topPicNews'][0]['thumb']); ?>" alt="<?php echo ($result["title"]); ?>"></a>
          </div>
        ...
        <div class="news-list">
          <?php if(is_array($result['listNews'])): $i = 0; $__LIST__ = $result['listNews'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
            ...
            <dd class="news-img">
              <a target="_blank" href="/index.php?c=detail&id=<?php echo ($vo["news_id"]); ?>"><img width="200" src="<?php echo ($vo["thumb"]); ?>" alt="<?php echo ($vo["title"]); ?>"></a>
            </dd>
            <dd class="news-intro">
